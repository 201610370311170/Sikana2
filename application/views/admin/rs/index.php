                ...
                <tbody>
                  ...
                  <?php foreach ($data as $rs):?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url().'admin/rumah_sakit/edit/'.$rs['id_rs']?>" class="btn btn-success" ><i class="fa fa-edit"></i></a>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <?php echo form_open('admin/rumah_sakit/register') ; ?>
                ...
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <div class="modal-body">
                          ...
                          <div class="pull-right">
                            <a href="<?php echo base_url().'admin/rumah_sakit/remove/'.$rs['id_rs'] ?>" type="button" value="Remove" class="btn btn-danger">Remove</a>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                          </div>
                          <br>
                    </div>
